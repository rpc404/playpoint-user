...
const Challenges = () => {
  ...
  React.useEffect(() => {
    ...
    if(prop=="filled"){
      _temp = _challenges.filter(_challenge => _challenge.slot==_challenge.participants.length);
      setTemp(_temp);
    }
    if(prop=="unfilled"){
      _temp = _challenges.filter(_challenge => _challenge.slot > _challenge.participants.length);
    ...
    if(prop=="my"){
      _temp = _challenges.filter(_challenge => _challenge.owner.walletID == userPublicAddress);
      setTemp(_temp);
    }
  }, [prop]);
    ...
    <div className="challenges__Container">
      <div className="challenges__AllChallenges">
        <div className="filters">
          ...
          {isWalletConnected && <button onClick={()=>setActiveProp("my")}>My Challenges</button> }
        </div>
            ...
            return (
              <div key={key} className="card">
                ...
                <div className="stat">
                    ...
                    <p className="filled">{challenge.participants.length} of {challenge.slot} Slots</p>
                </div>
